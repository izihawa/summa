...
pub fn parse_default_fields(schema: &Schema, default_fields: &[String]) -> SummaResult<Vec<String>> {
    Ok(default_fields
        .iter()
...
pub fn parse_multi_fields(schema: &Schema, multi_fields: &[String]) -> SummaResult<Vec<String>> {
    Ok(multi_fields
        .iter()
...
pub fn parse_primary_key(schema: &Schema, primary_key: &Option<String>) -> SummaResult<Option<String>> {
