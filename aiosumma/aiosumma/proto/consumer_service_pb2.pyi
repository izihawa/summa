...
class CreateConsumerRequest(_message.Message):
    __slots__ = ["bootstrap_servers", "consumer_name", "group_id", "index_alias", "topics"]
    ...
    def __init__(self, bootstrap_servers: _Optional[_Iterable[str]] = ..., group_id: _Optional[str] = ..., index_alias: _Optional[str] = ..., consumer_name: _Optional[str] = ..., topics: _Optional[_Iterable[str]] = ...) -> None: ...
