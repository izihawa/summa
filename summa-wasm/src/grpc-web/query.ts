...
class MoreLikeThisQuery$Type extends MessageType<MoreLikeThisQuery> {
    constructor() {
        super("summa.proto.MoreLikeThisQuery", [
            ...
            { no: 2, name: "min_doc_frequency", kind: "scalar", localName: "min_doc_frequency", opt: true, T: 4 /*ScalarType.UINT64*/ },
            { no: 3, name: "max_doc_frequency", kind: "scalar", localName: "max_doc_frequency", opt: true, T: 4 /*ScalarType.UINT64*/ },
            { no: 4, name: "min_term_frequency", kind: "scalar", localName: "min_term_frequency", opt: true, T: 4 /*ScalarType.UINT64*/ },
            { no: 5, name: "max_query_terms", kind: "scalar", localName: "max_query_terms", opt: true, T: 4 /*ScalarType.UINT64*/ },
            { no: 6, name: "min_word_length", kind: "scalar", localName: "min_word_length", opt: true, T: 4 /*ScalarType.UINT64*/ },
            { no: 7, name: "max_word_length", kind: "scalar", localName: "max_word_length", opt: true, T: 4 /*ScalarType.UINT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional uint64 min_doc_frequency */ 2:
                    message.min_doc_frequency = reader.uint64().toString();
                    break;
                case /* optional uint64 max_doc_frequency */ 3:
                    message.max_doc_frequency = reader.uint64().toString();
                    break;
                case /* optional uint64 min_term_frequency */ 4:
                    message.min_term_frequency = reader.uint64().toString();
                    break;
                case /* optional uint64 max_query_terms */ 5:
                    message.max_query_terms = reader.uint64().toString();
                    break;
                case /* optional uint64 min_word_length */ 6:
                    message.min_word_length = reader.uint64().toString();
                    break;
                case /* optional uint64 max_word_length */ 7:
                    message.max_word_length = reader.uint64().toString();
                    break;
...
class Score$Type extends MessageType<Score> {
    constructor() {
        super("summa.proto.Score", [
            ...
            { no: 2, name: "u64_score", kind: "scalar", localName: "u64_score", oneof: "score", T: 4 /*ScalarType.UINT64*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 u64_score */ 2:
                    message.score = {
                        oneofKind: "u64_score",
                        u64_score: reader.uint64().toString()
                    };
                    break;
                default:
                    let u = options.readUnknownField;
...
class FacetCollectorOutput$Type extends MessageType<FacetCollectorOutput> {
    constructor() {
        super("summa.proto.FacetCollectorOutput", [
            { no: 1, name: "facet_counts", kind: "map", localName: "facet_counts", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 4 /*ScalarType.UINT64*/ } }
        ]);
    }
...
class TopDocsCollector$Type extends MessageType<TopDocsCollector> {
    ...
    create(value?: PartialMessage<TopDocsCollector>): TopDocsCollector {
        const message = { limit: 0, offset: 0, snippet_configs: {}, explain: false, fields: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
